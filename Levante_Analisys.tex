...
\NormalTok{paquetes }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  ...
  \StringTok{"seasonal"}\NormalTok{, }\StringTok{"plotly"}\NormalTok{, }\StringTok{"lmtest"}
\NormalTok{  )}
...
\begin{table}[!h]
\centering
\caption{\label{tab:unnamed-chunk-8}Correlaciones Pearson y Spearman entre días de Levante y reclutamiento promedio por semestre. Se reportan ambos métodos por no-normalidad del viento.}
\centering
\begin{tabular}[t]{r|r|r|r|r|r}
\hline
Semestre & r Pearson & p Pearson & r Spearman & p Spearman & n\\
\hline
\cellcolor{gray!10}{1} & \cellcolor{gray!10}{-0.405} & \cellcolor{gray!10}{0.245} & \cellcolor{gray!10}{-0.377} & \cellcolor{gray!10}{0.283} & \cellcolor{gray!10}{10}\\
\hline
2 & 0.442 & 0.201 & 0.517 & 0.126 & 10\\
\hline
\end{tabular}
\end{table}
...
\begin{table}[!h]
\centering
\caption{\label{tab:unnamed-chunk-9}Comparación de modelos: R² ajustado, AIC y p-valor del test F global. El modelo con interacción se selecciona por menor AIC, aunque la interacción tiene p = 0.075 (a = 0.10).}
\centering
\begin{tabular}[t]{l|l|r|r|r}
\hline
  & Modelo & R2\_ajustado & AIC & p\_value\\
\hline
\cellcolor{gray!10}{Lineal} & \cellcolor{gray!10}{Lineal} & \cellcolor{gray!10}{-0.0297745} & \cellcolor{gray!10}{158.9262} & \cellcolor{gray!10}{0.5105547}\\
\hline
Cuadrático & Cuadrático & -0.0421342 & 160.0216 & 0.5517738\\
\hline
\cellcolor{gray!10}{Con semestre} & \cellcolor{gray!10}{Con semestre} & \cellcolor{gray!10}{0.3187816} & \cellcolor{gray!10}{151.5188} & \cellcolor{gray!10}{0.0148711}\\
\hline
Interacción & Interacción & 0.4102069 & 149.4240 & 0.0092298\\
\hline
\end{tabular}
\end{table}
...
\subsubsection{Diagnóstico del modelo seleccionado}\label{diagnuxf3stico-del-modelo-seleccionado}
...
\begin{table}[!h]
\centering
\caption{\label{tab:model-diagnostics-table}Tests de diagnóstico del modelo con interacción viento × semestre.}
\centering
\begin{tabular}[t]{l|l|r|r|l}
\hline
  & Test & Estadístico & p-valor & Conclusión\\
\hline
\cellcolor{gray!10}{W} & \cellcolor{gray!10}{Shapiro-Wilk (normalidad residuos)} & \cellcolor{gray!10}{0.907} & \cellcolor{gray!10}{0.0549} & \cellcolor{gray!10}{Residuos normales (p > 0.05)}\\
\hline
BP & Breusch-Pagan (homoscedasticidad) & 1.534 & 0.6750 & Varianza homogénea (p > 0.05)\\
\hline
\cellcolor{gray!10}{DW} & \cellcolor{gray!10}{Durbin-Watson (autocorrelación)} & \cellcolor{gray!10}{1.199} & \cellcolor{gray!10}{0.0419} & \cellcolor{gray!10}{Autocorrelación detectada (p < 0.05)}\\
\hline
\end{tabular}
\end{table}
...
{\centering \includegraphics[width=0.95\linewidth]{Levante_Analisys_files/figure-latex/model-diagnostics-plots-1} 

}

\caption{Gráficos de diagnóstico del modelo seleccionado: residuos vs. ajustados, Q-Q, escala-localización e influencia.}\label{fig:model-diagnostics-plots}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.7\linewidth]{Levante_Analisys_files/figure-latex/cook-distance-1} 

}

\caption{Distancia de Cook por semestre. La línea roja indica el umbral 4/n. Observaciones por encima pueden influir excesivamente en los coeficientes.}\label{fig:cook-distance}
\end{figure}
...
\caption{Cada punto representa un semestre. Líneas y bandas de IC al 95\% proceden del modelo de interacción conjunto (no de modelos separados por semestre). n total indicado en el subtítulo.}\label{fig:resultlm}
\end{figure}
...
\subsubsection{Relacion con Recruirt del modelo}\label{relacion-con-recruirt-del-modelo}

\begin{verbatim}
## # A tibble: 6 x 5
##   Scenario Variable   Year Media SDmedia
##   <chr>    <chr>     <dbl> <dbl>   <dbl>
## 1 s0       Depletion  2004 0.919  0.0575
## 2 s0       Depletion  2005 0.952  0.0771
## 3 s0       Depletion  2006 0.865  0.0760
## 4 s0       Depletion  2007 0.739  0.105 
## 5 s0       Depletion  2008 0.702  0.111 
## 6 s0       Depletion  2009 0.570  0.107
\end{verbatim}
...
## 
## data:  merged_df$log_recruit and merged_df$wind_lag1
## t = 0.61433, df = 10, p-value = 0.5527
...
##  Pearson's product-moment correlation
## 
## data:  merged_df$log_recruit and merged_df$wind_lag2
## t = 0.38388, df = 9, p-value = 0.71
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.5119265  0.6753783
## sample estimates:
...
\begin{center}\includegraphics[width=1\linewidth]{Levante_Analisys_files/figure-latex/unnamed-chunk-26-1} \end{center}
